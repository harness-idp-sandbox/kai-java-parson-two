...
# watch rollout
kubectl rollout status deploy/java-parson-two -n kaiser

# get external endpoint
kubectl get svc java-parson-two-svc -n kaiser
```
...
```bash
kubectl port-forward svc/java-parson-two-svc 8080:80 -n kaiser
...
kubectl rollout restart deploy/java-parson-two -n kaiser
kubectl rollout status deploy/java-parson-two -n kaiser
```
